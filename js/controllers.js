...
$scope.model_integrity_check = function() {
  ...
  for (var i=0; i < $scope.sst.xsecs.length; i++) {
    ...
    // Check for reversal of xsec coords   TODO: need to reverse the bezier curves
...
$scope.do_offset_clipper = function() {
  ...
  for (var i=0; i<$scope.sst2.selected_bulkhead.length; i++) {
    ...
    co.AddPath(subj, ClipperLib.JoinType.jtSquare, ClipperLib.EndType.etOpenSquare);
    var relief_index = 0;
    var new_subj = [];
